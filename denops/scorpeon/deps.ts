...
export type { Denops } from "https://deno.land/x/denops_std@v3.11.0/mod.ts";
export { g } from "https://deno.land/x/denops_std@v3.11.0/variable/variable.ts";
export {
  batch,
  gather,
} from "https://deno.land/x/denops_std@v3.11.0/batch/mod.ts";
export { decorate } from "https://deno.land/x/denops_std@v3.11.0/buffer/mod.ts";
export {
  assertArray,
  assertNumber,
  assertObject,
